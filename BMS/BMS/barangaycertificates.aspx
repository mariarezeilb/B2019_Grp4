<%@ Page Language="C#" AutoEventWireup="true" CodeFile="barangaycertificates.aspx.cs" Inherits="BMS.barangaycertificates" %>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-barangaycertificates.aspx">Barangay Clearance</a>
                    ...
                    <div class="container py-4">  
                                ...
                                <div class="container py-4">  
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-xs-12">
                                            <div class="form-group">
                                                <label>Purpose of Barangay Certification:</label>
