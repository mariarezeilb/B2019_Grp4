...
<body id="page-top" >
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Residents</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">SS</div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div>
                            <div class="card shadow mb-5">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                   <div id="map" width="1195" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></div>
                                    <div">
        ...
        function initMap() {
            ...
            google.maps.event.addListener(map, 'click',
                function (event) {
                    ...
                    addMarker({ croods: event.latLng });

                });

            addMarker({
                croods: { lat: 14.5119, lng: 121.0694 },
                content: "Hagonoy<p>"
            });
    ...
    <script async defer
      src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAuVyZWwqTq86AJctzNQmhb2hmUt5M7tQE&callback=initMap"
